...
/**
 * Returns help for Markdown editing
 * @TODO:  Dar soporte para multiidioma a las frases de la ayuda
 * @return string HTML
 */
function markdown_Help()
{
	$help = "<p class='textile'><strong>".gTxt('text_format')."</strong></p>
		<ul class='textile plain-list mono' \>
		    <li>*<em>".gTxt('emphasis')."</em>* _<em>".gTxt('emphasis')."</em>_ <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#em'>?</a></li>
		    <li>**<strong>".gTxt('strong')."</strong>** __<strong>".gTxt('strong')."</strong>__ <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#em'>?</a></li>
			<li><u>&lt;u&gt;".gTxt('underlined')."&lt;/u&gt;</u> <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#html'>?</a></li>
			<li>~~<strike>".gTxt('deleted_text')."</strike>~~ </li>
			<li><code>`".gTxt('source_code')."`</code> <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#code'>?</a></li>
		</ul>
		<p class='textile'><strong>".gTxt('link')."</strong><span class='mono'> [".gTxt('linktext')."](url '".gTxt('title')."')</span> <a class='pophelpsubtle' href='http://daringfireball.net/projects/markdown/syntax#link' aria-label='".gTxt('help')."' title='".gTxt('help')."' onclick='popWin(this.href, 450, 520); return false;' target='_blank' rel='help' role='button'>?</a></p>
		<p class='textile'><strong>".gTxt('image')."</strong><span class='mono'> ![".gTxt('alt_text')."](".gTxt('imageurl')." '".gTxt('title')."') </span><a class='pophelpsubtle' href='http://daringfireball.net/projects/markdown/syntax#img' aria-label='".gTxt('help')."' title='".gTxt('help')."' onclick='popWin(this.href, 450, 520); return false;' target='_blank' rel='help' role='button'>?</a></p>
		<p class='textile hidden'><strong>".gTxt('headers')."</strong> <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#header'>?</a></p>
		<ul class='textile plain-list mono'>
		    <li><strong><em>#</em></strong> ".gTxt('header')." 1</li>
		    <li><strong><em>##</em></strong> ".gTxt('header')." 2</li>
		    <div style='margin-bottom: 1em;'>
				<li style='line-height: 1em; margin-top: 0.5em; margin-bottom: 0.5em;'>".gTxt('header')." 1<br/>
				".str_repeat('=', strlen(gTxt('header').' 1'))."
				</li> 
				<li style='line-height: 1em; margin-bottom: 0.5em;'>".gTxt('header')." 2<br/>
				".str_repeat('=', strlen(gTxt('header').' 2'))."
				</li>
			</div>
		</ul>
		<p class='textile hidden'><strong>".gTxt('lists')."</strong> <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#list'>?</a></p>
		<ul class='textile plain-list mono' >
		    <li>".gTxt('numeric_list').": <strong class='mono'>n. </strong></li>
		    <li>".gTxt('bulleted_list').": <span class='mono'><strong>*</strong> <strong>+</strong> <strong>-</strong></span></li>
		    <li>".gTxt('definition_list').": <em>element</em><strong class='mono'> :</strong></li>
		</ul>
		<p class='textile hidden'><strong>".gTxt('block_modifiers')."</strong></p>
		<ul class='textile plain-list mono'>
		    <li>".gTxt('blockquote').": <strong>&gt;</strong> <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#blockquote'>?</a></li>
		    <li><cite>&lt;cite&gt;".gTxt('citation')."&lt;/cite&gt;</cite> <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#html'>?</a></li>
		    <li>&nbsp;&nbsp;".gTxt('preformatted_text')."</li>
		    <li>```<br/>
		    ".gTxt('source_code_block')."<br/>
		    ```<br/>
		    </li>
		    <li>~~~<br/>
		    ".gTxt('source_code_block')."<br/>
		...
		<p class='textile'><strong>".gTxt('line')."</strong> --- *** - - - <a role='button' rel='help' target='_blank' onclick='popWin(this.href, 450, 520); return false;' class='pophelpsubtle' title='".gTxt('help')."' aria-label='".gTxt('help')."' href='http://daringfireball.net/projects/markdown/syntax#hr'>?</a></p>
		<p class='textile'><strong>".gTxt('more')."</strong></p>
		<ul class='textile plain-list'>
		    <li><a href='http://daringfireball.net/projects/markdown/basics' target='_blank' rel='external'>Markdown</a> ".gTxt('and')." <a href='http://michelf.ca/projects/php-markdown/extra/' target='_blank' rel='external'>Markdown Extra</a></li>
		    <li><a href='http://stackedit.io/' target='_blank' rel='external'>".gTxt('online_editor')."</a></li>
		</ul>
		";
...
*/
	// Both helps for textile and markdown are shown. Is with Jquery where one or other (or none) are shown/hidden
	$help = "<div id='textile_help'>".Txp::get('Textpattern_Textfilter_Textile')->getHelp($rs['textile_body'])."</div>";
	$help .= "<div id='markdown_help'>".markdown_Help()."</div>";
